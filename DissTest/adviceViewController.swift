...
class adviceViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        goodWaterAv = db.databaseStore.getGoodAverage()
        poorWaterAv = db.databaseStore.getPoorWaterAverage()
        mediumSleepAv = db.databaseStore.getMediumAverage()
        mediumWaterAv = db.databaseStore.getGoodAverage()
        poorSleepAv = db.databaseStore.getPoorSleepAverage()
        goodSleepAv = db.databaseStore.getGoodSleepAverage()
        mediumSleepAv = db.databaseStore.getMediumSleepAverage()
        mediumAlcoholAv = db.databaseStore.getMediumALCOHOLAverage()
        poorAlcoholAv = db.databaseStore.getPoorAlcoholAverage()
        goodAlcoholAv = db.databaseStore.getGoodAlcoholAverage()
        goodExerciseAv = db.databaseStore.getGoodExerciseAverage()
        mediumExerciseAv = db.databaseStore.getMediumExerciseAverage()
        poorExerciseAv = db.databaseStore.getPoorExerciseAverage()
        overallSleep = db.databaseStore.getOverallSleep()
        overallExercise = db.databaseStore.getOverallExercise()
        overallAlcohol = db.databaseStore.getOverallAlcohol()
        overallWater = db.databaseStore.getOverallWater()
